...
You can download these scripts from this GitHub repository: [Oracle Scripts](https://github.com/asimondev/oracle-scripts)
...
[Database Creation]({{< relref "database_creation.md" >}})
